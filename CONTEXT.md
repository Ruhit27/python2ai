...
_Avoid_: Template, bot, assistant, product

**Agent**:
One part of the Agentic OS that does a single job for a Developer. Some run on a schedule (the Daily digest); others run when asked (Learn this, Dependency check).
_Avoid_: Skill, tool, bot, feature
